...
| 4 | STANDALONE-TRO | A TRO declaration with the structure the Specification requires, whose references resolve within it | ❌ not met |
...
| 4 | hashes-well-formed | The TRO's artifact and fingerprint hashes are well-formed sha256 | ❌ not met |
